...
def start_manager():
    ...
    # Fix: Create the manager instance outside the process target
    # and pass the queues as arguments instead
...
def run_manager_process(req_queue, resp_queue):
    """
    Function to run in a separate process.
    Creates and runs the ViserServerManager.
    """
    manager = ViserServerManager(req_queue, resp_queue)
    manager.run()
